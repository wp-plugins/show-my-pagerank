	...
	if($img != 'null')
		{
			...
			$pr_out_template = '<table border="0" >
				  <tr>
					<td><a href="http://www.sajithmr.com"><img src="'.get_option('siteurl').'/wp-content/plugins/Show-My-PageRank/pr/'.$img.'"  style="border: 1px solid #cccccc" width="'.get_option('my_pagerank_picture_width').'"></a></td>
				  </tr>
				  <tr>
